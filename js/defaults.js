let indicators = [
    { value: "pop_men", label: "Population (men)" },
    { value: "pop_women", label: "Population (women)" },
    { value: "pop", label: "Population (total)" },
    { value: "men_women_ratio", label: "Men/women ratio" },
    { value: "households", label: "Number of households" },
    { value: "avg_household_size", label: "Avg household size" },
    ...
    { value: "repeating_ratio", label: "% strudents repeating" },
    { value: "repeating_ratio_boys", label: "% strudents repeating (boys)" },
    { value: "repeating_ratio_girls", label: "% strudents repeating (girls)" },
